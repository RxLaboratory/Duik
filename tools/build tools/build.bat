...
:: Build Duik panels
DuBuilder "%repoPath%\DuCop.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\DuCop.jsx"
DuBuilder "%repoPath%\Duik Angela.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik Angela.jsx"
DuBuilder "%repoPath%\Duik Animation Library.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik Animation Library.jsx"
DuBuilder "%repoPath%\Duik Animation.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik Animation.jsx"
DuBuilder "%repoPath%\Duik Automation and expressions.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik Automation and expressions.jsx"
DuBuilder "%repoPath%\Duik Bones.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik Bones.jsx"
DuBuilder "%repoPath%\Duik Camera.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik Camera.jsx"
DuBuilder "%repoPath%\Duik Cmd.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik Cmd.jsx"
DuBuilder "%repoPath%\Duik Constraints.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik Constraints.jsx"
DuBuilder "%repoPath%\Duik Controllers.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik Controllers.jsx"
DuBuilder "%repoPath%\Duik Layer Manager.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik Layer Manager.jsx"
DuBuilder "%repoPath%\Duik Notes.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik Notes.jsx"
DuBuilder "%repoPath%\Duik OCO.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik OCO.jsx"
DuBuilder "%repoPath%\Duik Rigging.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik Rigging.jsx"
DuBuilder "%repoPath%\Duik Script Editor.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik Script Editor.jsx"
DuBuilder "%repoPath%\Duik Script Library.jsx" --no-banner "%build_path%\Duik\Scripts\ScriptUI Panels\Duik Script Library.jsx"
...
:: Build API reference
DuBuilder "%build_path%\Duik_API\Duik_api.jsxinc" --no-banner "%build_path%\Duik_API\Duik_api_fordoc.jsxinc"

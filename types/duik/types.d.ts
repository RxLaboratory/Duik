...
declare namespace Duik {
    ...
    namespace CmdLib {
         ...
         */
        namespace Duik.CmdLib['Animation'] { }
        /**
    ...
    namespace Layer {
         ...
         * @param [layer] - The layer. If omitted, will check the first selected layer of the current comp
         * @returns The type
         */
         ...
         * @param type - The type
         * @param [selectedOnly = true] - Whether to get only the selected layers or all of them
         * @param [comp = DuAEProject.getActiveComp()] - The comp
         * @param [notSelectedOnly = false] - Get only the not selected layers
         * @returns The layers of the specified type.
         */
        function get(type: Duik.Layer.Type, selectedOnly?: boolean, comp?: CompItem, notSelectedOnly?: boolean): Layer[];
        /**
         * Selects all the layers of the given type (and deselects others)
         * @param type - The type
         * @param [comp = DuAEProject.getActiveComp()] - The comp
         */
        function select(type: Duik.Layer.Type, comp?: CompItem): void;
        /**
         * Show/hides all the layers of the given type
         * @param type - The type
         * @param [comp = DuAEProject.getActiveComp()] - The comp
         * @param [notSelectedOnly = false] - Hides only the layers which are not selected
         */
        function toggleVisibility(type: Duik.Layer.Type, comp?: CompItem, notSelectedOnly?: boolean): void;
        /**
         * Checks the side of the layer
         * @param [layer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function side(layer?: Layer): OCO.Side;
        /**
         * Sets the side of the layer
         * @param side - The side
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer. If omitted, will use all selected layers in the comp
         */
        function setSide(side: OCO.Side, layers?: Layer[] | LayerCollection | DuList<Layer> | Layer): void;
        /**
         * Checks the location of the layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function location(layer?: Layer): OCO.Location;
        /**
         * Sets the location of the layer
         * @param side - The side
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer. If omitted, will use all selected layers in the comp
         */
        function setLocation(side: OCO.Side, layers?: Layer[] | LayerCollection | DuList<Layer> | Layer): void;
        /**
         * Checks the character name this layer belongs to
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function groupName(layer?: Layer): strng;
        /**
         * Sets the character name of the bone layer
         * @param characterName - The character name.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer. If omitted, will use all selected layers in the comp
         */
        function setGroupName(characterName: string, layers?: Layer[] | LayerCollection | DuList<Layer> | Layer): void;
        /**
         * Checks the limb name this layer belongs to
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function name(layer?: Layer): DuColor;
        /**
         * Sets the limb name of the bone layer
         * @param limbName - The limb name.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer. If omitted, will use all selected layers in the comp
         */
        function setName(limbName: string, layers?: Layer[] | LayerCollection | DuList<Layer> | Layer): void;
        /**
         * Copies the attributes from a layer to another layer.
         * @param to - The layer to set up
         * @param from - The source layer
         * @param type - The type of the layer to set up
         */
        function copyAttributes(to: Layer | Layer[] | LayerCollection | DuList<Layer>, from: Layer, type: Duik.Layer.Type): void;
        /**
         ...
         * @param type - The type
         * @param [name] - The name of the limb/layer
         * @param [side = OCO.Side.NONE] - The side
         * @param [location = OCO.Location.NONE] - The location
         * @param [groupName = ""] - The name of the character
         */
        function setAttributes(layer: Layer | Layer[] | LayerCollection | DuList<Layer>, type: Duik.Layer.Type, name?: string, side?: OCO.Side, location?: OCO.Location, groupName?: string): void;
        /**
         * Sets default name to a layer so it can be correctly managed by Duik, and sets the groups, tags & other metadata
         * @param [layers] - The layer(s). If omitted, will check the selected layers, or all layers, of the comp
         * @returns Parts used in the name: [type, group, name, location, side]
         */
        function sanitize(layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): string[];
        /**
         * Toggles the edit mode on selected layers
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer. If omitted, will use all selected layers in the comp
         */
        function unlink(layers?: Layer[] | LayerCollection | DuList<Layer> | Layer): void;
    }
    /**
    ...
    enum PseudoEffect {
        ...
        THREED_LIST = "",
        COLOR_LIST = "",
        THREE_DIMENSIONS_SCALE = "",
        THREE_DIMENSIONS_ANGLE = "",
        THREE_DIMENSIONS = "",
        TWO_DIMENSIONS_SCALE = "",
        TWO_DIMENSIONS_ANGLE = "",
        TWO_DIMENSIONS = "",
        COLOR = "",
        EXPOSE_TRANSFORM = "",
        KEY_MORPH = "",
    ...
    namespace Pin {
         ...
         * @param [comp = DuAEProject.getActiveComp()] - The containing composition
         * @param [type = Duik.Pin.Type.PIN] - The type
         * @returns The pin
         */
        function create(comp?: CompItem, type?: Duik.Pin.Type): ShapeLayer;
        /**
         * Links the property to a pin. This will automatically detect the type of the property to create the corresponding pins.
         * @param prop - The property
         * @param [tangents = true] - True to create pins for the tangents if prop is a Shape
         * @returns The pins created.
         */
        function add(prop: Property | DuAEProperty, tangents?: boolean): ShapeLayer[];
        /**
         ...
         * @returns The pins created.
         */
        function addPins(prop: PropertyGroup | DuAEProperty, tangents?: boolean): ShapeLayer[];
        /**
         * Adds a pin on a puppet pin
         * @param prop - The puppet pin
         * @returns The new pin.
         */
        function addPuppetPin(prop: PropertyGroup): ShapeLayer;
        /**
         * Gets a Pin layer in the comp or the selection.
         * @param comp - The composition where to get the bones
         * @param name - A name filter
         * @param [selectedOnly = false] - Selected layers only
         * @returns The pin layer.
         */
        function getByName(comp: CompItem, name: string, selectedOnly?: boolean): Layer | null;
        /**
         * Links the path to pins<br />
        Works with After Effects CC2018 (15.0) and newer only
         * @param prop - The path property
         * @param [tangents = true] - True to create bones for the tangents
         * @param [createPinLayers = true] - True to create layers, false to only create a controller effect
         * @returns The pin effects created.
         */
        function rigPath(prop: Property | DuAEProperty, tangents?: boolean, createPinLayers?: boolean): DuAEProperty[];
        /**
         * Links the path to the given layers.
         * @param pathProp - The path property (either an "ADBE Vector Shape - Group" or an "ADBE Mask Atom")
         * @param layers - The layers to link
         */
        function linkPathToLayers(pathProp: PropertyGroup | DuAEProperty, layers: Layer[]): void;
        /**
         * Links the puppet pins to the given layers.
         * @param pins - The path property (either an "ADBE FreePin3 PosPin Atom" or an "ADBE FreePin3 PosPin Position")
         * @param layers - The layers to link
         */
        function linkPuppetPinsToLayers(pins: Property[] | DuAEProperty[], layers: Layer[]): void;
        /**
         * Links a spatial property to a layer
         * @param prop - The property to link
         * @param boneLayer - The parent layer
         * @param [keepOffset = true] - True to not move the parent layer to the position of the property
         * @returns The effect created to link the bone.
         */
        function linkPositionToPin(prop: Property | DuAEProperty, boneLayer: Layer, keepOffset?: boolean): PropertyGroup;
        /**
         ...
         * @returns The bones
         */
        function get(selectedOnly?: boolean, comp?: CompItem): ShapeLayer[];
        /**
         * Checks the color of the pin layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected pin of the current comp
         */
        function color(layer?: Layer): DuColor;
        /**
         * Sets the color of the pin layers
         * @param color - The color
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setColor(color: DuColor, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): DuColor;
        /**
         * Checks the size of the pin layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected pin of the current comp
         */
        function size(layer?: Layer): float;
        /**
         * Sets the size of the pin layer
         * @param size - The size in %.
         * @param [layer = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setSize(size: float, layer?: Layer): void;
        /**
         * Checks the opacity of the pin layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function opacity(layer?: Layer): float;
        /**
         * Sets the opacity of the pin layer
         * @param opacity - The opacity in %.
         * @param [layer = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setOpacity(opacity: float, layer?: Layer): float;
        /**
         * Sets the side of the layer
         * @param side - The side
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer. If omitted, will use all selected layers in the comp
         */
        function setSide(side: OCO.Side, layers?: Layer[]): void;
        /**
         * Sets the location of the layer
         * @param side - The side
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setLocation(side: OCO.Side, layers?: Layer[]): void;
        /**
         * Sets the character name of the bone layer
         * @param characterName - The character name.
         * @param [layer = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setCharacterName(characterName: string, layer?: Layer): void;
        /**
         * Sets the limb name of the bone layer
         * @param limbName - The limb name.
         * @param [layer = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setLimbName(limbName: string, layer?: Layer): void;
    }
    /**
    ...
    namespace Bone {
         ...
         * @param [location = OCO.Location.FRONT] - The location of the arm
         * @param [forceLink = false] - whether link the selected layers/properties to the new armature
         */
        function arm(characterName?: string, type?: OCO.LimbType, side?: OCO.Side, shoulder?: boolean, arm?: boolean, forearm?: boolean, hand?: boolean, claws?: boolean, location?: boolean, forceLink?: boolean): void;
        /**
         * Creates a custom limb.
         * @param [num = 2] - The number of bones in case nothing is selected in the comp. Otherwize, a bone is created for each selected path vertex/puppet pin/layer.
         * @param [name = 'Limb'] - The name of the limb
         * @param [characterName] - The name of the character
         * @param [side = OCO.Side.NONE] - The side of the limb
         * @param [location = OCO.Location.NONE] - The location of the limb
         * @param [forceLink = false] - whether to link the selected layers/properties to the new armature
         */
        function customLimb(num?: int, name?: string, characterName?: string, side?: OCO.Side, location?: OCO.Location, forceLink?: boolean): void;
        /**
         * Creates a new arm.
         * @param [characterName] - The name of the character
         * @param [type = OCO.LimbType.HOMINOID] - The type of limb
         ...
         * @param [claws = false] - Whether to add claws
         * @param [location = OCO.Location.BACK] - The location of the leg
         * @param [forceLink = false] - whether link the selected layers/properties to the new armature
         */
        function leg(characterName?: string, type?: OCO.LimbType, side?: OCO.Side, thigh?: boolean, calf?: boolean, foot?: boolean, claws?: boolean, location?: boolean, forceLink?: boolean): void;
        /**
         * Creates a new spine.
         * @param [characterName] - The name of the character
         ...
         * @param [forceLink = false] - whether link the selected layers/properties to the new armature
         */
        function spine(characterName?: string, head?: boolean, neck?: int, spine?: int, hips?: boolean, forceLink?: boolean): void;
        /**
         * Creates a new tail.
         * @param [characterName] - The name of the character
         * @param [num = 3] - Number of tail bones
         * @param [forceLink = false] - whether link the selected layers/properties to the new armature
         */
        function tail(characterName?: string, num?: int, forceLink?: boolean): void;
        /**
         * Creates a new hair strand.
         * @param [characterName] - The name of the character
         * @param [num = 3] - Number of hair bones
         * @param [forceLink = false] - whether link the selected layers/properties to the new armature
         */
        function hair(characterName?: string, num?: int, forceLink?: boolean): void;
        /**
         * Creates a new wing.
         * @param [characterName] - The name of the character
         * @param [side = OCO.Side.LEFT] - The side
         ...
         * @param [forceLink = false] - whether link the selected layers/properties to the new armature
         */
        function wing(characterName?: string, side?: OCO.Side, arm?: boolean, forearm?: boolean, hand?: boolean, feathers?: int, forceLink?: boolean): void;
        /**
         ...
         * @param [forceLink = false] - whether link the selected layers/properties to the new armature
         */
        function snakeSpine(characterName?: string, head?: boolean, spine?: int, forceLink?: boolean): void;
        /**
         * Creates a new fin.
         * @param [characterName] - The name of the character
         * @param [side = OCO.Side.LEFT] - The side
         * @param [fishbones = true] - Number of fishbones to create
         * @param [forceLink = false] - whether link the selected layers/properties to the new armature
         */
        function fin(characterName?: string, side?: OCO.Side, fishbones?: int, forceLink?: boolean): void;
        /**
         ...
         * @param [forceLink = false] - whether link the selected layers/properties to the new armature
         */
        function fishSpine(characterName?: string, head?: boolean, spine?: int, forceLink?: boolean): void;
        /**
         ...
         */
        function linkLayers(layers: Layer[] | LayerCollection | DuList, boneLayers: Layer[] | LayerCollection | DuList): void;
        /**
         * Selects all the bones in the comp (and deselects any other layer)
         * @param [comp = DuAEProject.getActiveComp()] - The comp
         */
        function select(comp?: CompItem): void;
        /**
         * Show/hides all the bones
         * @param [comp = DuAEProject.getActiveComp()] - The comp
         * @param [notSelectedOnly = false] - Hides only the bones which are not selected
         */
        function toggleVisibility(comp?: CompItem, notSelectedOnly?: boolean): void;
        /**
         * Duplicates the selected bones, updates the hierarchy and display
         * @param [comp = DuAEProject.getActiveComp()] - The comp
         * @returns The new bones
         */
        function duplicate(comp?: CompItem): Layer[];
        /**
         * Toggles the edit mode on selected bones
         * @param [comp = DuAEProject.getActiveComp()] - The comp
         */
        function unlink(comp?: CompItem): void;
        /**
         * Bakes the "Armature" part of the Bone Data effect
         * @param [layers] - The layers to bake; will use selected layers from the current comp if omitted.
         */
        function bakeArmatureData(layers?: Layer[] | DuList<Layer> | Layer): void;
        /**
         * Bakes the appearance of the selected bones to improve performance by removing appearance-only expressions and effects.
         * @param [bakeBones = true] - Set to false to keep the bone display
         * @param [bakeEnvelop = true] - Set to false to keep the envelop settings
         * @param [bakeNoodles = true] - Set to false to keep all noodles even if they're hidden
         * @param [layers] - The layers to bake; will use selected layers from the current comp if omitted.
         * @param [reselectLayers = true] - Set to false to not reselect the bones after the baking process
         */
        function bake(bakeBones?: boolean, bakeEnvelop?: boolean, bakeNoodles?: boolean, layers?: Layer[] | DuList<Layer> | Layer, reselectLayers?: boolean): void;
        /**
         ...
         * @param [layers] - The artwork layers. If bones is omitted, it may also contain the bones.
         * @param [bones] - The bones to parent to. If omitted, will try to find them in layers, or in the comp if there's no bone in layers.
         * @param [useNames = false] - If true, will use layer names instead of locations to find the corresponding bone.
         */
        function autoParent(layers?: Layer[] | DuList<Layer> | LayerCollection, bones?: Layer[] | DuList<Layer> | LayerCollection, useNames?: boolean): void;
        /**
         * Tags the layers as rigged
         * @param bones - The bones to set
         * @param [rigged = true] - The value
         */
        function setRigged(bones: Layer[] | DuList<Layer> | Layer, rigged?: boolean): void;
        /**
         * Checks if the bone has already been rigged
         * @param bone - The bone to check
         * @returns true if it's been rigged
         */
        function isRigged(bone: Layer): boolean;
        /**
         * Rotates the chain so that the bones form a straight line.<br/>
        The bones must be parented together.
         * @param bones - The bones to align
         * @returns The list of the original rotations (before alignment)
         */
        function align(bones: ShapeLayer[] | DuList<ShapeLayer>): float[];
        /**
         * Gets the bone orientation value
         * @param bone - The bone
         * @returns The orientation
         */
        function getOrientation(bone: ShapeLayer): float;
        /**
         ...
         * @param [layers = Duik.Bone.get(false)] - The layers to include as bones in the doc
         * @returns the limbs
         */
        function getLimbs(layers?: Layer[]): ShapeLayer[][];
        /**
         * Sets the side of the layer
         * @param side - The side
         * @param [layers = Duik.Bone.get()] - The layer. If omitted, will use all selected layers in the comp
         */
        function setSide(side: OCO.Side, layers?: Layer[]): void;
        /**
         * Sets the location of the layer
         ...
         * @param [color] - The color. If omitted or null, will assign a random color for each bone.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setColor(color?: DuColor | null, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): void;
        /**
         ...
         * @returns The type
         */
        function type(layer?: Layer): OCO.Bone;
        /**
         * Checks if the bone layer has a visible envelop
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function hasEnvelop(layer?: Layer): boolean;
        /**
         * Toggles the envelop
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setEnvelopEnabled(enabled?: boolean, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): void;
        /**
         * Checks the size of the envelop of the bone layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function envelopSize(layer?: Layer): float;
        /**
         * Sets the size of the envelop of the bone layer
         * @param size - The new size
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setEnvelopSize(size: float, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): void;
        /**
         * Checks the offset of the envelop of the bone layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function envelopOffset(layer?: Layer): float;
        /**
         * Sets the offset of the envelop of the bone layer
         * @param offset - The offset
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setEnvelopOffset(offset: float, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): void;
        /**
         * Checks the opacity of the envelop of the bone layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function envelopOpacity(layer?: Layer): float;
        /**
         * Sets the opacity of the envelop of the bone layer
         * @param opacity - The opacity
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setEnvelopOpacity(opacity: float, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): void;
        /**
         * Checks the color of the envelop of the bone layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function envelopColor(layer?: Layer): DuColor;
        /**
         * Sets the color of the envelop of the bone layer
         * @param color - The color.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setEnvelopColor(color: DuColor, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): void;
        /**
         * Checks the stroke size of the envelop of the bone layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function envelopStrokeSize(layer?: Layer): float;
        /**
         * Sets the stroke size of the envelop of the bone layer
         * @param color - The color
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setEnvelopStrokeSize(color: float, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): void;
        /**
         * Checks the stroke color of the envelop of the bone layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function envelopStrokeColor(layer?: Layer): DuColor;
        /**
         * Sets the stroke color of the envelop of the bone layer
         * @param color - The color.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setEnvelopStrokeColor(color: DuColor, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): void;
        /**
         * Checks the color of the noodle of the bone layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function noodleColor(layer?: Layer): DuColor;
        /**
         * Sets the stroke color of the envelop of the bone layer
         * @param color - The color.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setNoodleColor(color: DuColor, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): void;
        /**
         * Toggles the noodle
         * @param [layers] - The layers. If omitted, will use all selected bones
         */
        function setNoodleEnabled(enabled?: boolean, layers?: Layer): void;
        /**
         ...
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function opacity(layer?: Layer): DuColor;
        /**
         * Sets the opacity of the bone layer
         * @param opacity - The opacity in %.
         * @param [layer = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         */
        function setOpacity(opacity: float, layer?: Layer): void;
        /**
         * Sets the character name of the bone layer
         * @param characterName - The character name.
         * @param [layer = DuAEComp.getSelectedLayers()] - The layers. If omitted, will use all selected layers in the comp
         ...
         */
        function resetTransform(layer: Layer): void;
    }
    /**
    ...
    namespace Controller {
         ...
         * @param [type = Duik.Controller.Type.TRANSFORM] - The type of the controller.
         * @param [parent = false] - Whether to parent the selected layers to the controllers or not.
         * @param [single = false] - Whether to create a single controller for all the layers or not.
         * @returns The new controllers.
         */
        function fromLayers(type?: Duik.Controller.Type, parent?: boolean, single?: boolean): ShapeLayer[];
        /**
         ...
         * @param [type = Duik.Controller.Type.TRANSFORM] - The type of Controller.
         * @param [layer] - The layer(s) where to create the controller.<br />
        If several layers are provided, will create the controller at the average center of their world positions.
         * @param [parent = false] - True to automatically parent the layer(s) to the controller
         * @returns The controller or null if it couldn't be created.
         */
        function create(comp?: CompItem, type?: Duik.Controller.Type, layer?: Layer | Layer[] | LayerCollection, parent?: boolean): ShapeLayer | AVLayer | null;
        /**
         * Gets an existing controller if there  is one at the correct location, or creates a new one.
         * @param layer - The layer where to create the controller.
         * @param [type = Duik.Controller.Type.TRANSFORM] - The type of Controller.
         * @param [controllers] - A list of existing controllers. If omitted, will get all the controllers of the comp.
         * @returns The controller
         */
        function getCreate(layer: Layer, type?: Duik.Controller.Type, controllers?: Layer[] | DuList<Layer>): Layer;
        /**
         ...
         * @param [layers] - The layers to bake; will use selected layers from the current comp if omitted.
         */
        function bake(layers?: Layer[] | DuList<Layer> | Layer): void;
        /**
         ...
         * @param preComposition - The precomposition layer
         * @param [useEssentialProperties = true] - Only in Ae v15.1 (CC2018) and up, true to use Master Properties<br />
        instead of expressions to link the controllers. Ignored on previous versions of After Effects.
         * @param [bake = true] - Bakes the appearances of the controllers before extracting them.<br />
        ...
        1: OK
         */
        function extract(preComposition: AVLayer, useEssentialProperties?: boolean, bake?: boolean): int;
        /**
         * Checks the tyoe of the controller layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected controller of the current comp
         */
        function type(layer?: Layer): Duik.Controller.Type;
        /**
         ...
         * @param [color] - The color. If omitted or null, will assign a random color for each bone.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer(s). If omitted, will use all selected layers in the comp
         */
        function setColor(color?: DuColor | null, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): DuColor;
        /**
         * Checks the size of the controller layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function size(layer?: Layer): DuColor;
        /**
         * Sets the size of the controller layers
         * @param size - The size
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer(s). If omitted, will use all selected layers in the comp
         */
        function setSize(size: float, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): DuColor;
        /**
         ...
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer(s). If omitted, will use all selected layers in the comp
         */
        function setOpacity(opacity: float, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): DuColor;
        /**
         * Checks the color of the anchor of the controller layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function anchorColor(layer?: Layer): DuColor;
        /**
         * Sets the color of the anchor of the controller layers
         * @param [color] - The color. If omitted or null, will assign a random color for each bone.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer(s). If omitted, will use all selected layers in the comp
         */
        function setAnchorColor(color?: DuColor | null, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): DuColor;
        /**
         * Checks the size of the anchor of the controller layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function anchorSize(layer?: Layer): DuColor;
        /**
         * Sets the size of the anchor of the controller layers
         * @param size - The size
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer(s). If omitted, will use all selected layers in the comp
         */
        function setAnchorSize(size: float, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): DuColor;
        /**
         * Checks the opacity of the anchor of the controller layer
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function anchorOpacity(layer?: Layer): DuColor;
        /**
         * Sets the opacity of the anchor of the controller layers
         * @param opacity - The opacity
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer(s). If omitted, will use all selected layers in the comp
         */
        function setAnchorOpacity(opacity: float, layers?: Layer | LayerCollection | Layer[] | DuList<Layer>): DuColor;
        /**
         ...
         * @param [comp = DuAEProject.getActiveComp()] - The comp
         * @param [notSelectedOnly = false] - Hides only the controllers which are not selected
         */
        function toggleVisibility(comp?: CompItem, notSelectedOnly?: boolean): void;
        /**
         ...
         */
        function pseudoEffect(preset: Duik.Controller.PseudoEffect): void;
        /**
         * Sets the type of the layers to Controller
         * @param [layers] - The layer. If omitted, will use all selected layers in the active comp
         * @param [type = Duik.Controller.Type.TRANSFORM] - The type of controllers to set. If omitted, will try to guess it from the layer name.
         */
        function tag(layers?: Layer[] | LayerCollection | DuList<Layer> | Layer, type?: Duik.Controller.Type): void;
        /**
         ...
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function id(layer?: Layer): int;
        /**
         * Gets the îd of the comp controlled by this extracted controller layer.
         * @param [layer = DuAEComp.getActiveLayer] - The layer. If omitted, will check the first selected bone of the current comp
         */
        function controlledComp(layer?: Layer): int;
        /**
         * Gets the controller type according to the (localized) given name, using the synonyms dictionnary
         * @param name - The name to look for
         * @param [fuzzy = true] - Performs a fuzzy search
         * @returns The controller type
         */
        function getControllerType(name: string, fuzzy?: boolean): Duik.Controller.Type;
    }
    /**
     * Constraint tools.
     */
    namespace Constraint {
        ...
        /**
         * List
         * @param [addKeyframe = false] - Set to true to automatically add a keyframe to the second slot (which makes it quicker to find in the AE Timeline using the 'U' shortcut)
         */
        function list(addKeyframe?: boolean): void;
        /**
         * Adds a list on a property
         * @param prop - The Property
         * @param [addKeyframe = false] - Set to true to automatically add a keyframe to the second slot (which makes it quicker to find in the AE Timeline using the 'U' shortcut)
         * @returns The list effect
         */
        function createList(prop: Property | DuAEProperty, addKeyframe?: boolean): DuAEProperty;
        /**
         * Separate Dimensions
         */
        function separateDimensions(): void;
        /**
         * Separates the dimensions of the properties into an effect.<br />
        Works with 2D, 3D, and colors
         * @param prop - The property
         * @returns The seperated properties (or the original one if it could not be separated)
         */
        function separatePropDimensions(prop: Property | DuAEProperty): DuAEProperty[];
        /**
         * Lock propery values
         * @param [props] - The properties. If omitted, locks the selected properties
         */
        function lock(props?: Property | DuAEProperty | Property[] | DuAeProperty[] | DuList<Property> | DuList<DuAEProperty>): void;
        /**
         * Zero-out selected layers
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer. If omitted, will use all selected layers in the comp
         * @returns The zeroes
         */
        function zero(layers?: Layer[] | LayerCollection | DuList<Layer> | Layer): ShapeLayer[];
        /**
         * Repositions the anchor points of the layers
         * @param location - The new location of the anchor points relative to the layer bounds.
         * @param [m = 0.0] - A margin, in pixels.
         * @param [includeMasks = false] - Use masks to compute the bounds.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer. If omitted, will use all selected layers in the comp
         */
        function moveAnchorPoint(location: DuMath.Location, m?: number, includeMasks?: boolean, layers?: Layer[] | LayerCollection | DuList | Layer): void;
        /**
         * Resets the transformation of the selected layers to 0.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer. If omitted, will use all selected layers in the comp
         * @param [opacity = false] - When true, also resets the opacity to 100%
         */
        function resetPRS(layers?: Layer[] | LayerCollection | DuList<Layer> | Layer, opacity?: boolean): void;
        /**
         * Align selected Layers to the last selected one
         * @param [position = true] - whether to align the position.
         * @param [rotation = true] - whether to align the rotation.
         * @param [scale = true] - whether to align the scale.
         * @param [opacity = true] - whether to align the opacity.
         */
        function alignLayers(position?: boolean, rotation?: boolean, scale?: boolean, opacity?: boolean): void;
        /**
         * Expose Transform
         * @param [comp] - The composition where to create the expose transform controller. The active composition by default.
         * @param [layers] - The layer with the transformation to expose. The selected layers by default. Can be an empty list too, in this case the Expose Transform controller is not set to measure any layer.
         * @returns The list of the new Expose Transform controllers. One per given layer.
         */
        function exposeTransform(comp?: CompItem, layers?: Layer[] | DuList): ShapeLayer[];
        /**
         * Morph Keys
         */
        function morphKeys(): void;
        /**
         * Creates an IK on the layers
         * @param [type = Duik.Constraint.IKType.ONE_TWO] - The type of IK to use with three layers.
         * @param [forceBezier = false] - force the use of a bezier IK even with two or three layers
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer. If omitted, will use all selected layers in the comp
         * @param [controller] - An already existing controller.
         * @param [bezierFK = false] - If forceBezier, adds a layer for FK Control
         * @returns The controller(s) of the IK.
         */
        function ik(type?: Duik.IKType, forceBezier?: boolean, layers?: Layer[] | LayerCollection | DuList<Layer> | Layer, controller?: Layer, bezierFK?: boolean): Layer[];
        /**
         * Creates a one-layer-ik on the layer
         * @param layer - The layer
         * @param [goal] - The goal layer, at the end of the IK
         * @param [controller] - The layer to use as a controller, can be automatically created.<br />
        Must be provided if goal is undefined
         * @param [showGuides = true] - Set to false to hide guides on the controllers (and improve performance)
         * @returns The controller created
         */
        function oneLayerIK(layer: Layer, goal?: Layer | null, controller?: Layer | Controller | null, showGuides?: boolean): Layer;
        /**
         * Creates a two-layer-ik on the layer
         * @param layer1 - The root layer
         * @param layer2 - The end layer
         * @param [goal] - The goal layer, at the end of the IK
         * @param [controller] - The layer to use as a controller, can be automatically created.<br />
        Must be provided if goal is undefined
         * @param [showGuides = true] - Set to false to hide guides on the controllers (and improve performance)
         * @returns The controller created
         */
        function twoLayerIK(layer1: Layer, layer2: Layer, goal?: Layer | null, controller?: Layer | null, showGuides?: boolean): Layer;
        /**
         * Creates a 1+2-layer-ik on the layer
         * @param layer1 - The root layer
         * @param layer2 - The middle layer
         * @param layer3 - The end layer
         * @param [goal] - The goal layer, at the end of the IK
         * @param [controller] - The layer to use as a controller, can be automatically created.<br />
        Must be provided if goal is undefined
         * @param [showGuides = true] - Set to false to hide guides on the controllers (and improve performance)
         * @returns The controller created
         */
        function oneTwoLayerIK(layer1: Layer, layer2: Layer, layer3: Layer, goal?: Layer | null, controller?: Layer | null, showGuides?: boolean): Layer;
        /**
         * Creates a 1+2-layer-ik on the layer
         * @param layer1 - The root layer
         * @param layer2 - The middle layer
         ...
         * @returns The controller created
         */
        function twoOneLayerIK(layer1: Layer, layer2: Layer, layer3: Layer, goal?: Layer | null, controller?: Layer | null, showGuides?: boolean): Layer;
        /**
         * Creates a bezier ik on the layers
         * @param layers - The layers, ordered from root to end
         * @param [goal] - The goal layer, at the end of the IK
         * @param [controller] - The layer to use as controller, can be automatically created.<br />
        Must be provided if goal is undefined.
         * @param [showGuides = true] - Set to false to hide guides on the controllers (and improve performance)
         * @returns The controllers [curve,end,root]
         */
        function bezierIK(layers: Layer[] | DuList, goal?: Layer | null, controller?: Layer | null, showGuides?: boolean): Layer[];
        /**
        ...
        Must be provided if goal is undefined.
         * @param [showGuides = true] - Set to false to hide guides on the controllers (and improve performance)
         * @param [rootController] - The layer to use as root controller, can be automatically created.
         * @returns The controllers [curve,end,root,rootpos, rootrot]
         */
        function bezierFK(layers: Layer[] | DuList<Layer>, goal?: Layer | null, controller?: Layer | null, showGuides?: boolean, rootController?: Layer | null): Layer[];
        /**
         * Creates a FK with auto-overlapping and its controller on the layers.
         * @param [layers] - The layers, already parented or ordered from root (at index 0) to end
         * @param [controller] - An already existing controller.
         * @returns The controller of the FK.
         */
        function fk(layers?: Layer[] | DuList<Layer>, controller?: Layer): Layer;
        /**
         * Auto-Parent. Parent selected layers to the last selected one.
         * @param [orphansOnly = false] - When true, parent only the orphans to the last selected layers
         * @param [layers] - The layers
         * @param [selectionOrder = false] - When true, parent in the order of the selection, from ancestor to child
         */
        function autoParent(orphansOnly?: boolean, layers?: Layer[] | DuList<Layer>, selectionOrder?: boolean): void;
        /**
         * Parent Constraint
         * @param [layers] - The layers
         */
        function parent(layers?: Layer[] | DuList<Layer>): void;
        /**
         * Add Locator
         * @param [layers] - The layers
         */
        function locator(layers?: Layer[] | DuList<Layer>): void;
        /**
        ...
        /**
         * Extract Locators
         * @param [useEssentialProperties] - whether to use essential properties instead of expressions to extract the controllers. True by default if Ae >= 17.0
         * @param [precompLayers] - The layers
         */
        function extractLocators(useEssentialProperties?: boolean, precompLayers?: Layer[] | DuList<Layer>): void;
        /**
         * Extracts one locator from a precomposition
         * @param locator - The locator to extract
         * @param preCompLayer - The precomposition layer
         * @param [useEssentialProperties = true] - true to extract using master properties instead of expressions (ignored in Ae < 15.1, false by default if 15.1 <= Ae < 17 and true by default in Ae >= 17)
         * @returns The extracted locator
         */
        function extractLocator(locator: ShapeLayer, preCompLayer: AVLayer, useEssentialProperties?: boolean): ShapeLayer;
        /**
         * Sets the current values of the locators. This fixes some bugs when unparenting layers parented to the locators.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer(s). If omitted, will use all selected layers in the comp
         * @param [disable = true] - whether to disable the expressions after having applied the values
         */
        function applyLocatorValues(layers?: Layer | LayerCollection | Layer[] | DuList<Layer>, disable?: boolean): void;
        /**
         * Disables the locator. Disable the transform expressions
         * @param [layers = DuAEComp.getSelectedLayers()] - The layer(s). If omitted, will use all selected layers in the comp
         */
        function disableLocator(layers?: Layer | LayerCollection | Layer[] | DuList<Layer>, disable?: boolean): void;
        /**
         * Parent the layers across compositions to the chosen layer
         * @param parent - The parent layer
         * @param [useEssentialProperties = true] - true to extract using master properties instead of expressions (ignored in Ae < 15.1, false by default if 15.1 <= Ae < 17 and true by default in Ae >= 17)
         * @param [children] - The child layers
         */
        function parentAcrossComp(parent: Layer, useEssentialProperties?: boolean, children?: Layer[] | DuList<Layer>): void;
        /**
         * Adds a position constraint to the layers
         * @param [layers] - The layers
         * @returns The effects added on the layers to control the constraint.
         */
        function position(layers?: Layer | Layer[] | DuList<Layer>): Property[];
        /**
         * Adds an orientation constraint to the layers
         * @param [layers] - The layers
         * @returns The effects added on the layers to control the constraint.
         */
        function orientation(layers?: Layer | Layer[] | DuList<Layer>): Property[];
        /**
         * Description
         * @param [path] - The path, taken from the layer selection if omitted
         * @param [layers] - The layers
         * @param [moveToPath = false] - Set to true to move the layer to the first point on the path
         * @returns true if a constraint could be created
         */
        function path(path?: PropertyBase | DuAEProperty, layers?: Layer[] | DuList<Layer>, moveToPath?: boolean): boolean;
        /**
         * Add pins on the properties
         * @param [tangents = true] - Set to false to ignore Bézier path tangents
         * @param [props] - The properties to pin
         * @returns The pins
         */
        function pin(tangents?: boolean, props?: PropertyBase[]): ShapeLayer[];
        /**
         ...
         * @returns The controller of the FK.
         */
        function simpleFK(layers?: Layer[] | DuList<Layer>, controller?: Layer): Layer;
        /**
         * Replace all <code>thisComp</code> occurences by <code>comp("name")</code>.
         * @param [selectionMode = DuAE.SelectionMode.ACTIVE_COMPOSITION] - The items where to modify the expressions.
         */
        function removeThisCompInExpressions(selectionMode?: Duik.SelectionMode): void;
        /**
         * Replace all <code>comp("name")</code> occurences by <code>thisComp</code>.
         * @param [selectionMode = DuAE.SelectionMode.ACTIVE_COMPOSITION] - The items where to modify the expressions.
         */
        function removeCompInExpressions(selectionMode?: Duik.SelectionMode): void;
        /**
         * Replace all <code>thisLayer</code> occurences by <code>layer("name")</code>.
         * @param [selectionMode = DuAE.SelectionMode.ACTIVE_COMPOSITION] - The items where to modify the expressions.
         */
        function removeThisLayerInExpressions(selectionMode?: Duik.SelectionMode): void;
        /**
         * Replace all <code>layer("name")</code> occurences by <code>thisLayer</code>.
         * @param [selectionMode = DuAE.SelectionMode.ACTIVE_COMPOSITION] - The items where to modify the expressions.
         */
        function removeLayerInExpressions(selectionMode?: Duik.SelectionMode): void;
        /**
         * Connects the properties to a master property.
         * @param props - The child properties
         * @param masterProp - The parent property
         * @param [min = 0] - The minimum value
         * @param [max = 100] - The maximum value
         * @param [axis = DuAE.Axis.X] - The axis or channel to connect
         * @param [type = DuAE.Type.VALUE] - The type
         * @param [toKeyMorph] - By default, the connector will detect Key Morphs to adjust the connection on the weight of the selected keys.<br/>
         ...
         * @returns The controlling effect created
         */
        function connector(props: DuAEProperty[] | DuList<DuAEProperty>, masterProp: Property | DuAEProperty, min?: float, max?: float, axis?: DuAE.Axis, type?: DuAE.Type, toKeyMorph?: boolean): PropertyGroup;
        /**
         * Connects the properties together to a % slider
         * @param [props] - The properties to connect. The selected properties by default.
         */
        function quickConnector(props?: Property[] | DuAEProperty[]): void;
        /**
         ...
         * @param dropdown - The dropdown menu property.
         * @param [layers] - The layers to control. The selected layers by default.
         */
        function linkLayersToDropdown(dropdown: DuAEProperty | Property, layers?: Layer[] | DuList<Layer>): void;
        /**
         * Prepares a visual audio controller to connect to properties
         * @param [audioLayer] - The layer with the audio to setup. The selected layer by default.
         * @returns The value to use with the connector
         */
        function setupAudioController(audioLayer?: AVLayer): DuAEProperty;
    }
    /**
     * (Auto)Rigging tools.
     */
    namespace Rig {
         ...
         * @param [bakeBones = true] - Whether to bake bones
         * @param [bakeEnvelops = true] - Whether to bake envelops
         * @param [bakeNoodles = true] - Whether to remove deactivated noodles
         * @param [longChainMode = Duik.Constraint.IKType.FK] - Set to true if you prefer using Bézier IK than FK with overlap for tails and other chains consisting of more than 3 layers.
         * @param [threeLayerMode = Duik.Constraint.IKType.ONE_TWO] - The type of IK to use with custom 3-layer chains.
         * @param [layers] - The layers to rig. All selected layers by default.
         * @param [createMaster = false] - Set to true to add a master/root controller which controls all other controllers
         * @returns The controllers which are used in the rig
         */
        function auto(bakeBones?: boolean, bakeEnvelops?: boolean, bakeNoodles?: boolean, longChainMode?: Duik.Constraint.IKType, threeLayerMode?: Duik.Constraint.IKType, layers?: Layer[] | DuList<Layer>, createMaster?: boolean): Layer[];
        /**
         ...
         * @param limb - The limb to parent
         * @param bone - The parent bone
         */
        function parentLimb(limb: OCOLimb, bone: OCOBone): void;
        /**
         * Auto-rigs an OCOLimb if it exists in the comp
         * @param limb - The limb to rig
         * @param [customControllers] - Existing custom controllers to use
         * @param [longChainMode = Duik.Constraint.IKType.FK] - How to rig tails and other chains consisting of more than 3 layers.
         * @param [threeLayerMode = Duik.Constraint.IKType.ONE_TWO] - How to rig 3-layer chains.
         */
        function limb(limb: OCOLimb, customControllers?: Layer[] | DuList<Layer>, longChainMode?: Duik.Constraint.IKType, threeLayerMode?: Duik.Constraint.IKType): void;
        /**
         * Rigs a spine.
         * @param [layers] - The layers to rig
         * @param [customControllers] - Existing custom controllers to use
         * @returns The controllers for the spine.
         */
        function spine(layers?: Layer[] | DuList<Layer>, customControllers?: Layer[] | DuList<Layer>): Layer[];
        /**
         * Rigs a tail.
         * @param [layers] - The layers to rig
         * @param [tailMode = Duik.Constraint.IKType.FK] - How to rig tails and other chains consisting of more than 3 layers.
         * @param [customControllers] - Existing custom controllers to use
         * @returns The controller(s) of the tail
         */
        function tail(layers?: Layer[] | DuList<Layer>, tailMode?: Duik.Constraint.IKType, customControllers?: Layer[] | DuList<Layer>): Layer[];
        /**
         * Rigs a leg.
         * @param [layers] - The layers to rig
         * @param [customControllers] - Existing custom controllers to use
         * @returns The controller leg
         */
        function leg(layers?: Layer[] | DuList<Layer>, customControllers?: Layer[] | DuList<Layer>): Layer;
        /**
         * Rigs a shoulder (an FK and an auto-position effect)
         * @param shoulder - The shoulder bone
         * @param ctrl - The controller
         */
        function shoulder(shoulder: Layer, ctrl: Layer): void;
        /**
         * Returns the bone from the spine bones the closest to the location, where child bones at that location can be attached
         * @param location - The location where to attach bones, in comp coordinates
         * @param spineBones - The bones of the spine, sorted from root (hips) to tip
         * @returns The corresponding spine bone or null if the list of spine bones is empty
         */
        function getSpineAttach(location: float[], spineBones: Layer[]): Layer | null;
        /**
         * Rigs an arm/front leg.
         * @param [layers] - The layers to rig
         * @param [customControllers] - Existing custom controllers to use
         * @returns The controller of the arm
         */
        function arm(layers?: Layer[] | DuList<Layer>, customControllers?: Layer[] | DuList<Layer>): Layer;
        /**
         * Rigs a fin.
         * @param [layers] - The layers to rig
         * @param [customControllers] - Existing custom controllers to use
         * @returns The controller of the fin
         */
        function fin(layers?: Layer[] | DuList<Layer>, customControllers?: Layer[] | DuList<Layer>): Layer;
        /**
         * Rigs the spine of a fish (head + tail).
         * @param [layers] - The layers to rig
         * @param [rigMode = Duik.Constraint.IKType.FK] - How to rig tails and other chains consisting of more than 3 layers.
         * @param [customControllers] - Existing custom controllers to use
         * @returns An object with two Arrays: bones and controllers.
         */
        function fishSpine(layers?: Layer[] | DuList<Layer>, rigMode?: Duik.Constraint.IKType, customControllers?: Layer[] | DuList<Layer>): any;
        /**
         * Rigs a wing with feathers
         * @param [layers] - The layers to rig
         * @param [customControllers] - Existing custom controllers to use
         * @returns The controller of the wing
         */
        function wing(layers?: Layer[] | DuList<Layer>, customControllers?: Layer[] | DuList<Layer>): Layer;
        /**
         * Rigs hair strands
         * @param [layers] - The layers to rig
         * @param [customControllers] - Existing custom controllers to use
         * @returns The controllers for the hair
         */
        function hair(layers?: Layer[] | DuList<Layer>, customControllers?: Layer[] | DuList<Layer>): Layer[];
        /**
         * Rigs custom chains
         * @param [layers] - The layers to rig
         * @param [tailMode = Duik.Constraint.IKType.FK] - How to rig tails and other chains consisting of more than 3 layers.
         * @param [threeLayerMode = Duik.Constraint.IKType.ONE_TWO] - How to rig tails and other chains consisting of more than 3 layers.
         * @param [customControllers] - Existing custom controllers to use
         * @returns The controllers
         */
        function custom(layers?: Layer[] | DuList<Layer>, tailMode?: Duik.Constraint.IKType, threeLayerMode?: Duik.Constraint.IKType, customControllers?: Layer[] | DuList<Layer>): Layer[];
    }
    /**
    ...
    namespace Automation {
         ...
         * @returns The type of the comp; Duik.Automation.NLACompType.NONE if it's not part of an NLA.
         */
        function NLAType(): Duik.Automation.NLACompType;
        /**
         * Gets the folder containing the NLA Compositions like the given comp.
         * @param comp - The comp
         * @returns The folder or null if the comp is not part of an NLA
         */
        function getNLAFolder(comp: CompItem): FolderItem | null;
        /**
         * Gets the render, original and edit comps for this NLA
         * @param nlaFolder - The NLA Folder
         * @returns The compositions in this order: [Original, Edit, Render]. Note that if one is not found, null is returned.
         */
        function getNLAComps(nlaFolder: FolderItem): CompItem[];
        /**
         * Sets up a non-linear animation comp.
         * @param [comp] - The composition to set up. The active composition if omitted.
         * @param [selectedProps = true] - Use only currently selected properties if true, all properties (according to the other options) if false.
         * @param [transformProps] - If true, filters only properties in the transform group of the layers. Ignored if selectedProps is true.
         * @param [effectProps] - If true, filters only properties in effects. Ignored if selectedProps is true.
         * @param [layerTypes = [Duik.Layer.Type.CONTROLLER]] - The types of layer to setup if there's no selected layer; if empty, will setup all layers.
         * @param [props] - A list of properties to set up. In case this parameter is provided, all other parameters are ignored.
         */
        function setupNLA(comp?: CompItem, selectedProps?: boolean, transformProps?: boolean, effectProps?: boolean, layerTypes?: Duik.Layer.Type[], props?: PropertyBase[] | DuList | DuAEProperty[]): void;
        /**
         * Creates a clip and adds it to the NLA
         * @param [nlaComp] - A comp belonging to an NLA, the active comp if omitted.
         * @returns Success code: 1 if the clip could be created, 0 if the original comp is not found, -1 if the NLA is invalid/not found
         */
        function addNLAClip(nlaComp?: CompItem): int;
        /**
         * Adds a loop expression and pseudo effect with more options than the loopOut and loopIn expressions.
         * @param [props] - The properties to loop. The selected properties in the active comp if omitted.
         * @param [effect] - The pseudo effect to use if it already exists.
         * @returns The pseudo-effect
         */
        function looper(props?: PropertyBase[] | DuList<PropertyBase> | PropertyBase, effect?: PropertyGroup): PropertyGroup;
        /**
         ...
         * @param [prop] - The property, the selected/active property if omitted.
         * @returns The expression.
         */
        function copyExpression(prop?: Property | DuAEProperty): string;
        /**
         * Pastes the expression previously copied with {@link Duik.Automation.copyExpression}.
         * @param [props] - The properties where to paste the expression, the selecte properties if omitted.
         * @param [expression] - A specific expression to paste.
         */
        function pasteExpression(props?: Property[] | DuAEProperty[], expression?: string): void;
        /**
         ...
         * @param [props] - The properties, the selected properties if omitted (or the selected layers).
         */
        function removeExpressions(keepPostExpressionValue?: boolean, props?: Property[] | DuAEProperty[]): void;
        /**
         * Disables the expressions from the properties.
         * @param [props] - The properties, the selected properties if omitted (or the selected layers).
         */
        function toggleExpressions(props?: Property[] | DuAEProperty[]): void;
        /**
         ...
         * @param [selectionMode = DuAE.SelectionMode.SELECTED_PROPERTIES] - The expressions to bake
         */
        function bakeExpressions(mode?: DuAEExpression.BakeAlgorithm, frameStep?: float, selectionMode?: Duik.SelectionMode): void;
        /**
         * Bakes the expressions to keyframes, and remove all non-renderable layers
         * @param [mode = DuAEExpression.BakeAlgorithm.SMART] - The algorithm to use for baking the expressions.
         * @param [frameStep = 1.0] - By default, checks one value per keyframe. A lower value increases the precision and allows for sub-frame sampling. A higher value is faster but less precise.
         */
        function bakeComposition(mode?: DuAEExpression.BakeAlgorithm, frameStep?: float): void;
        /**
         * Creates a spatial effector to control the selected properties.
         * @param [comp] - The composition containing the effector. The active composition by default.
         */
        function effector(comp?: CompItem): void;
        /**
         * Creates a map (texture) effector to control the selected properties.
         * @param mapLayer - The layer to use as a texture/map.
         * @param [props] - The properties, the selected properties if omitted (or the selected layers).
         */
        function effectorMap(mapLayer: AVLayer, props?: Property[] | DuAEProperty[]): void;
        /**
         ...
         * @param [props] - The properties, the selected properties if omitted (or the selected layers).
         * @param [effect] - The pseudo effect to use if it already exists.
         * @returns The Kleaner effect (or null if there's no property to setup).
         */
        function kleaner(props?: PropertyBase[] | DuAEProperty[] | DuList<PropertyBase> | PropertyBase | DuAEProperty, effect?: PropertyGroup): PropertyGroup | null;
        /**
         ...
         * @param [props] - The properties, the selected properties if omitted (or the selected layers).
         * @param [blink = false] - Set to true to set the interpolation to hold by default.
         * @returns The Swink effects.
         */
         ...
         * @param [props] - The properties, the selected properties if omitted (or the selected layers).
         */
        function wiggle(separateDimensions?: boolean, individualControls?: boolean, props?: PropertyBase[] | DuAEProperty[] | DuList<PropertyBase> | PropertyBase | DuAEProperty): void;
        /**
         ...
         * @param [props] - The properties, the selected properties if omitted (or the selected layers).
         */
        function random(separateDimensions?: boolean, individualControls?: boolean, props?: PropertyBase[] | DuAEProperty[] | DuList<PropertyBase> | PropertyBase | DuAEProperty): void;
        /**
         * Automates the rotation of layers as wheels
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers
         */
        function wheel(layers?: AVLayer | AVLayer[] | DuList<AVLayer>): void;
        /**
         * Adds a control to move the layers away from their parent.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers
         */
        function moveAway(layers?: AVLayer | AVLayer[] | DuList<AVLayer>): void;
        /**
         ...
         * @param [offset = true] - If true, offsets the current values. If false, sets absolute values.
         * @param [separate = true] - If true, sets a different value for all axis. If false, use the same value for all axis, ignore Y and Z values.
         * @param [gaussian = true] - If true, uses random values with a gaussian distribution instead of true random values.
         * @param [props] - The properties, the selected properties if omitted (or the selected layers).
         */
        function randomizeValues(xMin?: float, xMax?: float, yMin?: float, yMax?: float, zMin?: float, zMax?: float, offset?: boolean, separate?: boolean, gaussian?: boolean, props?: PropertyBase[] | DuAEProperty[] | DuList<PropertyBase> | PropertyBase | DuAEProperty): void;
        /**
         * Shuffles the layer start times (moves them in time).
         * @param min - The minimum value, in frames.
         * @param max - The maximum value, in frames.
         * @param [offset = true] - If true, offsets the current values. If false, sets absolute values.
         * @param [gaussian = true] - If true, uses random values with a gaussian distribution instead of true random values.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers
         */
        function randomizeLayerTimes(min: int, max: int, offset?: boolean, gaussian?: boolean, layers?: AVLayer | AVLayer[] | DuList<AVLayer>): void;
        /**
         ...
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers
         */
        function randomizeLayerIndices(min: int, max: int, offset?: boolean, gaussian?: boolean, layers?: AVLayer | AVLayer[] | DuList<AVLayer>): void;
        /**
         ...
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers
         */
        function randomizeLayerInPoints(min: int, max: int, offset?: boolean, gaussian?: boolean, layers?: AVLayer | AVLayer[] | DuList<AVLayer>): void;
        /**
         ...
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers
         */
        function randomizeLayerOutPoints(min: int, max: int, offset?: boolean, gaussian?: boolean, layers?: AVLayer | AVLayer[] | DuList<AVLayer>): void;
        /**
         ...
         * @param [props] - The properties, the selected properties if omitted (or the selected layers).
         */
        function randomizeKeyTimes(min: int, max: int, offset?: boolean, gaussian?: boolean, props?: PropertyBase[] | DuAEProperty[] | DuList<PropertyBase> | PropertyBase | DuAEProperty): void;
        /**
         ...
         * @param [props] - The properties, the selected properties if omitted (or the selected layers).
         */
        function randomizeKeyValues(xMin?: float, xMax?: float, yMin?: float, yMax?: float, zMin?: float, zMax?: float, offset?: boolean, separate?: boolean, gaussian?: boolean, props?: PropertyBase[] | DuAEProperty[] | DuList<PropertyBase> | PropertyBase | DuAEProperty): void;
        /**
         * Draws a trail following the selected layers.
         * @param [createNewLayer = false] - Option to create a new layer for each trail.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers
         */
        function motionTrail(createNewLayer?: boolean, layers?: AVLayer | AVLayer[] | DuList<AVLayer>): void;
        /**
         * Activates the time remapping on the layers, adjusts the keyframes and adds a loop effect.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers
         */
        function timeRemap(layers?: AVLayer | AVLayer[] | DuList<AVLayer>): void;
        /**
         * Rigs paint effects and brush strokes to animate them more easily.
         * @param [layers = DuAEComp.getSelectedLayers()] - The layers
         */
        function paintRig(layers?: AVLayer | AVLayer[] | DuList<AVLayer>): void;
        /**
         * Animates the selected character using a procedural walk or run cycle.
         * @param [controllers] - The controllers to setup. If omitted, will get the selected controllers, or all the controllers of the current comp.
         */
        function walk(controllers?: Layer[] | DuList<Layer>): void;
        /**
         * Animates the given controllers with a wolk/run cycle.
         * @param ctrls - The controllers to setup. An object containing these layers:<br />
         ...
         */
        function rigWalk(ctrls: any): void;
    }
    /**
    ...
    namespace Animation {
         ...
         * @param [selectedLayers = false] - Set to true to get the keyframes only on the selected layers instead of all the layers.
         * @param [controllersOnly = true] - Set to false to get the keyframes from all types of layers instead of just the controllers.
         * @param [range] - The time range to select the keyframes, [in, out]. If omitted, will use the work area of the composition.
         * @param [propertyMatchNames = []] - The list of matchnames to select only keyframes of a specific type. If empty, will select all types of keyframes.
         */
        function selectKeyframes(comp?: CompItem, selectedLayers?: boolean, controllersOnly?: boolean, range?: Number[], propertyMatchNames?: string[] | DuList): void;
        /**
         * Copies the currently selected keyframes, which can then be pasted with {@link Duik.Animation.paste}.
         * @param [comp = DuAEProject.getActiveComp] - The composition
         * @returns The list of animations which have been copied.
         */
        function copy(comp?: CompItem): DuAELayerAnimation[];
        /**
         * Cuts the currently selected keyframes, which can then be pasted with {@link Duik.Animation.paste}.
         * @param [comp = DuAEProject.getActiveComp] - The composition
         * @returns The list of animations which have been copied.
         */
        function cut(comp?: CompItem): DuAELayerAnimation[];
        /**
         * Pastes the animation previously copied by {@link Duik.Animation.copy} to the selected properties.
         * @param [comp] - The composition.
         * @param [replace = false] - Whether to completely erase and replace the current animation
         * @param [offset = false] - Whether to offset the animation from the current value
         * @param [reverse = false] - Whether to reverse the animation
         */
        function paste(comp?: CompItem, replace?: boolean, offset?: boolean, reverse?: boolean): void;
        /**
         * Control the selected keyframes with advanced but easy-to-use keyframe interpolation driven by an effect.
         * @param [props] - The properties to interpolate. The selected properties in the active comp if omitted.
         * @param [effect] - The pseudo effect to use if it already exists.
         * @returns The pseudo-effect
         */
        function interpolator(props?: PropertyBase[] | DuList | PropertyBase, effect?: PropertyGroup): PropertyGroup;
        /**
         * Adds a roving key to the properties at current time
         * @param [animatedProps = true] - Set to false to add a key to all selected properties, instead of all animated properties.
         * @param [selectedLayers = true] - Set to false to add a key to all layers instead of just the selection.
         */
        function addRovingKey(animatedProps?: boolean, selectedLayers?: boolean): void;
        /**
         * Sets the selected keyframes to roving
         */
        function setRoving(): void;
        /**
         * Adds a linear key to the properties at current time
         * @param [animatedProps = true] - Set to false to add a key to all selected properties, instead of all animated properties.
         * @param [selectedLayers = true] - Set to false to add a key to all layers instead of just the selection.
         */
        function addLinearKey(animatedProps?: boolean, selectedLayers?: boolean): void;
        /**
         * Sets the selected keyframes to linear
         */
        function setLinear(): void;
        /**
         * Adds an Ease In key to the properties at current time
         * @param [animatedProps = true] - Set to false to add a key to all selected properties, instead of all animated properties.
         * @param [selectedLayers = true] - Set to false to add a key to all layers instead of just the selection.
         * @param [ease = 33] - The ease influence.
         */
        function addEaseInKey(animatedProps?: boolean, selectedLayers?: boolean, ease?: int): void;
        /**
         * Sets the selected keyframes to ease in
         * @param [ease = 33] - The ease influence.
         */
        function setEaseIn(ease?: int): void;
        /**
         ...
         * @param [ease = 33] - The ease influence.
         */
        function addEaseOutKey(animatedProps?: boolean, selectedLayers?: boolean, ease?: int): void;
        /**
         * Sets the selected keyframes to ease out
         * @param [ease = 33] - The ease influence.
         */
        function setEaseOut(ease?: int): void;
        /**
         * Adds an Easy Ease key to the properties at current time
         * @param [animatedProps = true] - Set to false to add a key to all selected properties, instead of all animated properties.
         * @param [selectedLayers = true] - Set to false to add a key to all layers instead of just the selection.
         * @param [easeIn = 33] - The ease in influence.
         * @param [easeOut = 33] - The ease out influence.
         */
        function addEasyEaseKey(animatedProps?: boolean, selectedLayers?: boolean, easeIn?: int, easeOut?: int): void;
        /**
         * Sets the selected keyframes to easy ease
         * @param [easeIn = 33] - The ease in influence.
         * @param [easeOut = 33] - The ease out influence.
         */
        function setEasyEase(easeIn?: int, easeOut?: int): void;
        /**
         * Adds a Continuous key to the properties at current time
         * @param [animatedProps = true] - Set to false to add a key to all selected properties, instead of all animated properties.
         * @param [selectedLayers = true] - Set to false to add a key to all layers instead of just the selection.
         */
        function addContinuousKey(animatedProps?: boolean, selectedLayers?: boolean): void;
        /**
         * Sets the selected keyframes to continuous
         */
        function setContinuous(): void;
        /**
         * Adds a Hold key to the properties at current time
         * @param [animatedProps = true] - Set to false to add a key to all selected properties, instead of all animated properties.
         * @param [selectedLayers = true] - Set to false to add a key to all layers instead of just the selection.
         */
        function addHoldKey(animatedProps?: boolean, selectedLayers?: boolean): void;
        /**
         * Sets the selected keyframes to hold
         */
        function setHold(): void;
        /**
         * Sets the ease values on the selected keyframes
         * @param easeIn - The in ease
         * @param easeOut - The out ease
         */
        function setEase(easeIn: float, easeOut: float): void;
        /**
         * Sets the velocity values on the selected keyframes
         * @param vIn - The in velocity
         * @param vOut - The out velocity
         */
        function setVelocity(vIn: float, vOut: float): void;
        /**
         * Sets the selected keyframes spatial interpolation
         */
        function setSpatialInterpolation(): void;
        /**
         * Sets the selected keyframes spatial interpolation to linear
         */
        function setSpatialLinear(): void;
        /**
         * Sets the selected keyframes spatial interpolation to linear
         */
        function setSpatialBezierIn(): void;
        /**
         * Sets the selected keyframes spatial interpolation to linear
         */
        function setSpatialBezierOut(): void;
        /**
         * Sets the selected keyframes spatial interpolation to linear
         */
        function setSpatialBezier(): void;
        /**
         * Sets the selected keyframes spatial interpolation to linear
         */
        function fixSpatialInterpolation(): void;
        /**
         * Adds a key to the properties at current time, tweening according to the previous and next keyframe
         * @param [tweenRatio = 0.5] - The value ratio for tweening: 0.0 is the value of the previous key, 1.0 is the value of the next key. Note that this value can be < 0 and > 1.0 if you wish.
         * @param [animatedProps = true] - Set to false to add a key to all selected properties, instead of all animated properties.
         * @param [selectedLayers = true] - Set to false to add a key to all layers instead of just the selection.
         */
        function tween(tweenRatio?: float, animatedProps?: boolean, selectedLayers?: boolean): void;
        /**
         * Splits the selected keyframes into couple of keyframes with the same values
         * @param [duration = 2] - The number of frames between the two keyframes.
         * @param [alignment = DuAE.TimeAlignment.CENTER] - How to align the new keyframes according to the current time.
         */
        function splitKeys(duration?: int, alignment?: DuAE.TimeAlignment): void;
        /**
         * Freezes the pose; copies the previous keyframe to the current time.
         * @param [animatedProps = true] - Set to false to add a key to all selected properties, instead of all animated properties.
         * @param [selectedLayers = true] - Set to false to add a key to all layers instead of just the selection.
         * @param [useNextPose = false] - If true, will freeze the next pose instead of the previous one (copies the next keyframe to the current time).
         */
        function freezePose(animatedProps?: boolean, selectedLayers?: boolean, useNextPose?: boolean): void;
        /**
         * (De)activates or updates the onion skin of a Duik cel animation comp.
         * @param [enabled = true] - If omitted, will try to get it from the existing cels.
         * @param [frames = 5] - The duration (in frames) of the onion skin. If omitted, will try to get it from the existing cels.
         * @param [exposure = 2] - The animation exposure. If omitted, will try to get it from the existing cels.
         * @param [inOpacity = 50] - The in opacity. If omitted, will try to get it from the existing cels.
         * @param [outOpacity = 50] - The out opacity. If omitted, will try to get it from the existing cels.
         */
        function celOnionSkin(enabled?: boolean, frames?: int, exposure?: int, inOpacity?: float, outOpacity?: float): void;
        /**
         * Creates a new cel for a Duik cel animation
         * @param [createNewLayer = false] - Set to true to create the cel on a new layer
         */
        function newCel(createNewLayer?: boolean): void;
        /**
         * Goes to the previous frame in a Duik cel animation
         * @param [exposure = 2] - The animation exposure
         */
        function previousCel(exposure?: int): void;
        /**
         * Goes to the next frame in a Duik cel animation
         * @param [exposure = 2] - The animation exposure
         */
        function nextCel(exposure?: int): void;
        /**
         * Snaps selected (or all) keyframes to the closest frames if they're in between.
         */
        function snapKeys(): void;
        /**
         ...
         * @param [onLast = false] - If true, syncs using the last keyframe instead of the first
         */
        function syncKeys(onLast?: boolean): void;
        /**
         * Sequences selected layers.
         * @param [duration = 24] - The transition duration, in frames
         * @param [moveLayers = true] - If set to false, the layer are not moved, and the in or out points are changed instead (layers are "cut")
         * @param [useInPoints = true] - If moveLayers is false, setting this to false changes the out points instead of the in points (cuts the end instead of the start).
         * @param [reverse = false] - Set to true to reverse the order.
         * @param [interpolation = DuInterpolation.linear] - An interpolation function, taking 4 arguments in the form <code>i(value, min, max, targetMin, targetMax)</code>
         */
        function sequenceLayers(duration?: int, moveLayers?: boolean, useInPoints?: boolean, reverse?: boolean, interpolation?: (...params: any[]) => any): void;
        /**
         ...
         * @param [interpolation = DuInterpolation.linear] - An interpolation function, taking 4 arguments in the form <code>i(value, min, max, targetMin, targetMax)</code>
         */
        function sequenceKeys(duration?: int, reverse?: boolean, interpolation?: (...params: any[]) => any): void;
        /**
         * Adjusts the exposure of the animation.
         * @param [autoCompute = false] - (Try to) auto-compute the best values..
         */
        function xSheet(autoCompute?: boolean): void;
        /**
         * Snaps the IK to the FK values.
         * @param [ctrls] - The controllers to snap.
         */
        function snapIK(ctrls?: Layer[] | DuList<Layer>): void;
        /**
         * Snaps the FK to the IK values.
         * @param [ctrls] - The controllers to snap.
         */
        function snapFK(ctrls?: Layer[] | DuList<Layer>): void;
        /**
         * Switches between IK and FK.
         * @param [ctrls] - The controllers to switch.
         * @param [addKeyframes = true] - Whether to add keyframes on FK and IK properties to keep the switch at the current frame.
         */
        function switchIKFK(ctrls?: Layer[] | DuList<Layer>, addKeyframes?: boolean): void;
    }
    /**
     * Camera toolkit
     */
    namespace Camera {
         ...
         * @param [comp] - The composition. The active composition if omitted.
         * @returns The frame layer
         */
        function frame(comp?: CompItem): ShapeLayer;
        /**
         ...
         * @param [layers] - The layers to constrain. The selected layers if omitted.$
         * @returns Error code. 1: OK; 0: No camera in the comp, -1: No (selected) layers.
         */
        function scaleZLink(layers?: Layer[] | Layer | DuList<Layer>): int;
        /**
         * Rigs a camera to make it easier to animate
         * @param [camera] - The camera to rig. If omitted, will try to find it in selected layers or the active comp.
         * @param [separateDimensions] - Whether to separate the position dimensions on the controllers. If the option is not set, Duik will check if the current camera has its dimensions separated first
         * @returns An array of controllers: [target, cam, main], which may be empty if no camera was found or if it was a one-node camera.
         */
        function rig(camera?: CameraLayer, separateDimensions?: boolean): ShapeLayer[];
        /**
         * Creates a 2D Multiplane Camera
         * @param [layers] - Some layers to parent to the new camera.
         * @returns The camera layer and its levels (camera is the first layer in the Array).
         */
        function twoDCamera(layers?: Layer[] | Layer | DuList<Layer>): ShapeLayer[];
    }
    /**
     * Miscellaneous tools
     */
    namespace Tool {
         ...
         * @param [precomps] - The precompositions to crop. The selected layers by default.
         */
        function cropPrecompositions(precomps?: AVLayer[] | LayerCollection | DuList | AVLayer): void;
        /**
         * Edits the selected expression using an external editor
         * @param [prop] - The propety containing the expression. The first selected property if omited.
         * @returns The file used to edit the expression.
         */
        function editExpression(prop?: Property | DuAEProperty): File;
        /**
...
declare class OCODoc {
     ...
     * @param [name] - The name of the character. If omitted, will use the comp name.
     * @param [comp = DuAEProject.getActiveComp()] - The composition
     * @param [layers = Duik.Bone.get(false)] - The layers to include as bones in the doc
     * @param [characterTop] - The max Y coordinate of the character, in px in the comp
     * @param [characterCenterOfMass] - The coordinates of center of mass of the character, in px in the comp
     * @param [ground] - The Y coordinate of the ground, in px in the comp
     * @param [height = 185] - The height of the character, in cm
     * @returns The new doc
     */
    static fromComp(name?: string, comp?: CompItem, layers?: Layer[], characterTop?: float, characterCenterOfMass?: float[], ground?: float, height?: float): DoOCODoc;
    /**
     * Creates the limbs and armatures in the comp
     * @param [comp] - The composition to use. If omitted, creates a new composition.
     * @param [duration = 60.0] - The duration of the new comp, in seconds.
     * @param [float = 24.0] - The frame rate of the new comp.
     * @returns The new layers
     */
    toComp(comp?: CompItem, duration?: float, float?: frameRate): Layer[];
    /**
...
declare class OCOLimb {
     ...
     * @param doc - The doc containing the limb.
     * @param [comp = DuAEProject.getActiveComp()] - The composition to use.
     * @param [parentLayer = null] - The parent layer of the bone.
     * @param [limbId] - A Unique identifier for this armature. If omitted, a new one will be assigned.
     * @returns The new layers
     */
    toComp(doc: OCODoc, comp?: CompItem, parentLayer?: Layer, limbId?: int): Layer[];
    /**
     ...
     * @param pathProp - The path property (either an "ADBE Vector Shape - Group" or an "ADBE Mask Atom")
     * @returns The root bone of the new chain
     */
    armatureFromPath(doc: OCODoc, name: string, pathProp: PropertyGroup | DuAEProperty): OCOBone;
    /**
     * Moves the armature of the limb to the vertices of the path.
     * @param doc - The doc containing the limb.
     * @param pathProp - The path property (either an "ADBE Vector Shape - Group" or an "ADBE Mask Atom")
     */
    moveArmatureToPath(doc: OCODoc, pathProp: PropertyGroup | DuAEProperty): void;
    /**
     * Moves the armature of the limb to the puppet pins.
     * @param doc - The doc containing the limb.
     * @param pins - The puppet pins
     */
    moveArmatureToPuppetPins(doc: OCODoc, pins: Property[] | DuAEProperty[]): void;
    /**
     ...
     * @returns The root bone of the new chain
     */
    armatureFromPuppetPins(doc: OCODoc, name: string, pins: Property[] | DuAEProperty[]): OCOBone;
    /**
     * Moves the armature of the limb to the layers.
     * @param doc - The doc containing the limb.
     * @param layers - The layers
     */
    moveArmatureToLayers(doc: OCODoc, layers: Layer[] | LayerCollection): void;
    /**
     ...
     * @returns The root bone of the new chain
     */
    armatureFromLayers(doc: OCODoc, name: string, layers: Layer[] | LayerCollection): OCOBone;
    /**
     * Gets the After Effects layers representing this limb
     * @returns May be an empty array if this limb has not been created in After Effects yet
     */
    getLayers(): Layer[];
    /**
     * The limbs/ Armatures
...
declare class OCOBone {
    ...
    /**
     * Creates the limbs and armatures in the comp
     * @param doc - The doc containing the bone.
     * @param limb - The limb containing the bone.
     * @param [comp = DuAEProject.getActiveComp()] - The composition to use.
     * @param [parentLayer = null] - The parent layer of the bone.
     * @param [limbId] - A Unique identifier for this armature. If omitted, a new one will be assigned.
     * @param [boneIndex = 0] - The index of the bone in the chain.
     * @returns The new layers
     */
    toComp(doc: OCODoc, limb: OCOLimb, comp?: CompItem, parentLayer?: Layer, limbId?: int, boneIndex?: int): Layer[];
    /**
     * Gets the After Effects child layers of this bone (including it)
     * @returns May be an empty array if this bone has not been created in After Effects yet
     */
    getLayers(): Layer[];
    /**
     * Creates a bone using a layer from a comp
     * @param layer - the layer
     * @param doc - the doc which will be containing the bone. Needed for coordinates.
     * @returns the bone
     */
    static fromComp(layer: Layer, doc: OCODoc): OCOBone;
    /**
     * Gets the (localized) synonyms of this name
     * @param name - The name to look for
     * @param [fuzzy = true] - Performs a fuzzy search
     * @returns The synonyms. A 'score' property is added to the object to be used in case of fuzzy search.
     */
    static getNameSynonyms(name: string, fuzzy?: boolean): string[];
    /**
     ...
     * @returns The bone id
     */
    static getBoneId(name: string, fuzzy?: boolean): OCO.Bone;
    /**
...
declare namespace DuIO {
    ...
    namespace Animation {
        /**
         * Pastes the animation previously copied by {@link Duik.Animation.copy} to the selected properties.
         * @param data - The animation data to paste
         * @param [comp] - The composition.
         * @param [replace = false] - Whether to completely erase and replace the current animation
         * @param [offset = false] - Whether to offset the animation from the current value
         * @param [reverse = false] - Whether to reverse the animation
         * @param [matchNames = []] - A filter to apply only on specific property types
         * @param [keyframesOnly = true] - If false, the value of properties without keyframes will be set too.
         * @param [expressions = false] - If true, the expression is set too.
         * @param [dontMoveAncestors = false] - When set to true, the transform (position, rotation) values for ancestor layers (the ones without parent) will be offset to 0 before applying the animation.
         */
        function paste(data: DuAELayerAnimation[], comp?: CompItem, replace?: boolean, offset?: boolean, reverse?: boolean, matchNames?: string[], keyframesOnly?: boolean, expressions?: boolean, dontMoveAncestors?: boolean): void;
        /**
         * Copies all the animations on selected layers, and saves them to a Json file.
         * @param file - The file to save the data
         * @param [layers] - An array of Layers or LayerCollection with the animation. Selected layers from the current comp if omitted.
         * @param [selectedKeysOnly] - Wether to copy only selected keys or not. If omitted, will be true if there are selected keyframes, false otherwise.
         * @returns The animations
         */
        function toJson(file: File, layers?: Layer[] | DuList<Layer> | LayerCollection, selectedKeysOnly?: boolean): DuAELayerAnimation[];
        /**
         * Loads an animation file and applies it on the layers
         * @param jsonFile - The file containing the animation
         * @param [layers] - The layers. If omitted, will get the selected layers from the current comp, or all layers if none are selected.
         * @param [keyframesOnly = false] - If true, will load only keyframes, but not static values or expressions.
         * @param [matchNames = []] - A filter for the properties to load. If empty, will load all properties.
         * @param [offset = false] - Whether to offset the current values or use absolute values.
         * @param [reverse = false] - Whether to reverse the keyframes in time.
         */
        function fromJson(jsonFile: File, layers?: Layer[] | DuList<Layer> | LayerCollection, keyframesOnly?: boolean, matchNames?: string[], offset?: boolean, reverse?: boolean): void;
        /**
         ...
         * @param data - The animation
         * @returns The data cleaned
         */
        function cleanExportData(data: any): any;
        /**
         ...
         * @param type - The After Effects interpolation type

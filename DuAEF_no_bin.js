...
*/
DuAEF.DuAE.Layer.addPseudoEffect = function (layer,preset,matchName)
{
...
*/
DuAEF.DuAE.Comp.haveSelectedKeys = function (layers)
{
...
DuAEF.DuAE.Property.setAnim = function(prop,anim,time,ignoreName,setExpression,ignoreMatchName)
{
	...
	else if (prop.numProperties != undefined)
	{
		if (prop.numProperties > 0)
		{
			...
			{
				ok = (DuAEF.DuAE.Property.setAnim(prop.property(pi),anim,time,ignoreName,setExpression));
			}
		}
	}
	return ok;
...
DuAEF.DuAE.Property.setInterpolationType = function(layers,props,typeIn,typeOut,easeInValue,easeOutValue)
{
	...
	if (!DuAEF.DuAE.Comp.haveSelectedKeys(layers))
	{
		for (var i=0;i<props.length;i++)
		{
...
DuAEF.DuScriptUI.addImageButton = function (container,text,image,helpTip,imageOver,debug)
{
	...
	{
		try { imageButton.onClick(); } catch (e) { if (imageButton.debug) alert('An error has occured in file at line ' + e.line + '\n\n' + e.description); }
	}
...
DuAEF.DuScriptUI.addNiceCheckBox = function (container,text,helpTip,color,debug)
{
	...
	*/
	...
	niceCheckBox.labelClicked = function (e)
	{
		...
		try { niceCheckBox.onClick(); } catch (e) { if (debug) alert('An error has occured at line ' + e.line + '\n\n' + e.description); }
	}
 ...
 */
DuAEF.DuScriptUI.addNiceEditText = function(container,text,prefix,suffix)
{
	...
	niceEditText.static = niceEditText.add('statictext',undefined,prefix + text + suffix);
	...
	{
		niceEditText.editing = false;
		niceEditText.static.text = niceEditText.prefix + niceEditText.edit.text + niceEditText.suffix;
...
* @class DuSettings
* @classdesc A class to manager settings.

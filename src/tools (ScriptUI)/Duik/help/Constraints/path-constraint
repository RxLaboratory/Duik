(Standard and Expert modes) The Path Constraint constraints the position of a layer to any Bézier path (CC2018 and up only).
...
NOTE: the position of the layer can still be animated, and you can move it yourself to the path if you want it to be exactly above. In this case, set the percentage to 0% and move the layer above the first vertex of the Bezier path.

...
2. a. Select the master property in the timeline, and click on "Pick Master Property". The name of the master property will be shown on the button.
    b. You can also use one of the three controllers of Duik espacially made to be used by the connector (the slider, the 2D slider and the angle)
...
2. a. To control this head turn, we will not use an existing property, but create a nice controller just for it:
    c. Go to the main composition, from where you will animate the head
    b. In the panel of the connector, click on the "Slider" button

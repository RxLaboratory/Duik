...
//Le problème ne se pose que si on est sur un effet, pas sur une transformation. Autrement dit, si la profondeur est égale à 3.
if (effetProfondeur == 3){
//Récupérer le nom de l'effet
var effetParentName = effet.parentProperty.name;
//les curseurs
...
//===========================================
	...
	palette.bounds = [300,300,560,665];
		...
		//bouton lookat
		var boutonlookat = panoanimation.add("button",[120,60,230,80],"LookAt");
		boutonlookat.onClick = onebone;
		boutonlookat.helpTip = traduction(["The first selected layer will always be oriented towards the second selected layer","Le calque sélectionné en premier pointera toujours vers le calque sélectionné en deuxième"]);

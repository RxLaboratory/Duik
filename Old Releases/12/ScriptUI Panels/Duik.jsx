...
//UI
//===========================================
var dossierIcones = Folder.startup.absoluteURI  + "/Scripts/Duik Icons/";
...
// fonction pour vérifier que les scripts ont les droits décriture
	...
	if (isSecurityPrefSet() == true) { 
		var folderTest = new Folder(Folder.startup.absoluteURI  + "/Scripts/Duik Icons/");
		if (folderTest.exists)  IKtools(this);
		else alert( traduction(["\"Duik Icons\" folder is missing in \"" + Folder.startup.fsName + "/Scripts/" + "\r\n\r\nYou can find this folder in the zip archive you've downloaded from Duik's website","Il manque le dossier des icônes \"Duik Icons\" dans \"" + Folder.startup.fsName + "\\Scripts\"" + "\r\n\r\nVous trouverez ce dossier dans l'archive que vous avez téléchargée sur le site de Duik","\"Duik Icons\" folder is missing in \"" + Folder.startup.fsName + "\\Scripts\"" + "\r\n\r\nYou can find this folder in the zip archive you've downloaded from Duik's website"]));
		} else {

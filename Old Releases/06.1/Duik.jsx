...
//===========================================
	...
	palette.bounds = [300,300,560,640];
		palette.add ("statictext", [5,   5,105, 25],  "DuDuF IK Tools v6.1");
		var boutonhelp = palette.add ("button",[110,5,125,20],"?");
		boutonhelp.onClick = help;

		var panocre = palette.add("panel",[5,30,250,125],"Expressions");
		...
		var panoobj = palette.add("panel",[5,130,250,175],"Objets");
		...
		var panocam = palette.add("panel",[5,185,250,230],"Cameras");

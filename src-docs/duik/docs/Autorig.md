...
The Auto-rig in Duik Bassel is a versatile and smart tool which adapts to a lot of different situations. This makes it the cornerstone of the [rigging process](../Rigging) in Duik, which can be summarized to:
...
To make this process the easiest possible, an [IK/FK Switch](../IK-FK-Switch) tool is provided with the [animation tools](../Animation-Tools).

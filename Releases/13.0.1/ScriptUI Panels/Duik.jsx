...
if (!dossierIcones.exists) dossierIcones = Folder.current.absoluteURI  + "/Duik Icons/";
if (!dossierIcones.exists) dossierIcones = Folder.startup.absoluteURI  + "/Scripts/Duik Icons/";
...
// fonction pour vérifier que les scripts ont les droits décriture
    ...
    if (!folderTest.exists) folderTest = new Folder(Folder.current.absoluteURI  + "/Duik Icons/");
    if (!folderTest.exists) folderTest = new Folder(Folder.startup.absoluteURI  + "/Scripts/Duik Icons/");

    var laPalette = null;
    
	if (folderTest.exists) {
		if (isSecurityPrefSet() == true)  laPalette = IKtools(this);
		else {
